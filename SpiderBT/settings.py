...
SECRET_KEY = '=7jsz#nncjspq@bn^*mvhr6rbcdrd)u8!9b%f0pmb(s9$9m^tl'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'SpiderBT.context_processors.global_settings',
                'SpiderBT_Cases.context_processors.global_settings',
...
WSGI_APPLICATION = 'SpiderBT.wsgi.application'
...
AUTHENTICATION_BACKENDS = (
    ...
    'social_core.backends.twitch.TwitchOAuth2', # for Twitter authentication
...
SOCIAL_AUTH_GITHUB_AUTH_EXTRA_ARGUMENTS = {'redirect_uri': '<yourdomain>/auth/complete/github/'}
